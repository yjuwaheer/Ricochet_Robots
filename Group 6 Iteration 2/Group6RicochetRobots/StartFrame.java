...
public class StartFrame extends JFrame implements ActionListener
{
    ...
    private JRadioButton easy, difficult;
    ...
    private JCheckBox p1, p2, p3, p4; //players
    private JComboBox p1Type, p2Type, p3Type, p4Type; //player's type
    
    private JComboBox c1Type, c2Type, c3Type, c4Type; //computer's difficulty type
    
    private JFrame info; //frame for message alert box
    
    GridBagConstraints gbc = new GridBagConstraints();
    String[] playerType = { "Human", "Computer"};
    String[] compType = { "Easy", "Hard"};
