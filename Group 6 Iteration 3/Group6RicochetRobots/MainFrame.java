...
public class MainFrame extends JFrame
{
    ...
    //Sub layouts for the main layout
    private JPanel centerLayout;
    private JPanel belowLayout;
    ...
    {        
        ...
        centerLayout = new JPanel(new GridLayout(2,2));
        belowLayout = new JPanel(new GridLayout(0,2));
        leftLayout = new JPanel(new GridLayout(0,2));
        rightLayout = new JPanel(new GridLayout(0,2));
