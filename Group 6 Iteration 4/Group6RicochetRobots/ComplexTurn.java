 ...
 */
public class ComplexTurn
{
    private ArrayList<Integer> enteredNums = new ArrayList<>();
    //timer
    //list of solutions if there are multiple
    private ComplexSolution bestSolution;
    private static ComplexSolution currentSolution;
    ...
    public static ComplexSolution getCurrentSolution()
    {
    ...
    {
        currentSolution = new ComplexSolution(currentPlayer);
        ///boolean robotOnSquare = false;
    }
